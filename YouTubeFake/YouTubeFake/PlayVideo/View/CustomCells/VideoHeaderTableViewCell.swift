...
class VideoHeaderTableViewCell: UITableViewCell {
    ...
    func configHorizontalButtons(_ videoModel : ItemVideo){
    ...
    func configCell(videoModel : ItemVideo, channelModel : ItemsChannel?){
    ...
    private func channelDetails(_ videoModel : ItemVideo, _ channelModel : ItemsChannel?){
...
extension VideoHeaderTableViewCell : ButtonIconListProtocol{
